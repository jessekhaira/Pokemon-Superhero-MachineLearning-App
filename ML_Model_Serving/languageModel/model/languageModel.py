...
def main(vocab_dim, hidden_dim, learning_rate, epochs=10):
    ...
    with open(os.path.abspath('') +'/jsonified_items/jsonified_char_to_index.json', 'r') as f:
        char_to_index = json.load(f) 

    with open(os.path.abspath('') +'/jsonified_items/jsonified_index_to_char.json', 'r') as f:
