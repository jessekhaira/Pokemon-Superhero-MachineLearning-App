...
class LanguageModel extends React.Component {
    ...
    /**
     * This function provides a description for the label of the temperature input tag for the language model.
     */
    _addHTML_tempLabel() {
    ...
    /**
     * This function wraps each name generated by the AI algorithm in a div and then adds the divs to a 
     * results holder. 
     * @param {HTMLElement} resultsLM DOM node that represents a div holding the results of the language generation 
